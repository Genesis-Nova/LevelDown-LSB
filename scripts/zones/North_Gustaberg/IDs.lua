...
zones[xi.zone.NORTH_GUSTABERG] =
{
    text =
    {
        ...
        SENSE_EVIL_PRESENCE           = 7353,  -- You sense an evil presence...
        SPARKLING_LIGHT               = 7394,  -- The ground is sparkling with a strange light.
        SHINING_OBJECT_SLIPS_AWAY     = 7458,  -- The shining object slips through your fingers and is washed further down the stream.
        REACH_WATER_FROM_HERE         = 7465,  -- You can reach the water from here.
        CONQUEST                      = 7501,  -- You've earned conquest points!
        ITEMS_ITEMS_LA_LA             = 7853,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7859,  -- The Goblin slipped away when you were not looking...
        GARRISON_BASE                 = 7869,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        ...
        VOIDWALKER_DESPAWN            = 8123,  -- The monster fades before your eyes, a look of disappointment on its face.
        TIME_ELAPSED                  = 8199,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
