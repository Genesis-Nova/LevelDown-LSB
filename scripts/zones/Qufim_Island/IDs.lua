...
zones[xi.zone.QUFIM_ISLAND] =
{
    text =
    {
        ...
        THESE_WITHERED_FLOWERS         = 7348,  -- These withered flowers seem unable to bloom.
        NOW_THAT_NIGHT_HAS_FALLEN      = 7349,  -- Now that night has fallen, the flowers bloom with a strange glow.
        CONQUEST                       = 7397,  -- You've earned conquest points!
        AN_EMPTY_LIGHT_SWIRLS          = 7756,  -- An empty light swirls about the cave, eating away at the surroundings...
        GARRISON_BASE                  = 7761,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        GIGANTIC_FOOTPRINT             = 7840,  -- There is a gigantic footprint here.
        ASA_SNOW                       = 7853,  -- You see the following words scrawled into the snow: Shantotto Empire Provisional Headquarters.
        ...
        DYNA_NPC_DEFAULT_MESSAGE       = 7990,  -- There is a strange symbol drawn here. A haunting chill sweeps through you as you gaze upon it...
        ...
        UNITY_WANTED_BATTLE_INTERACT   = 8134,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED              = 10348, -- New training regime registered!
        LEARNS_SPELL                   = 12666, -- <name> learns <spell>!
        UNCANNY_SENSATION              = 12668, -- You are assaulted by an uncanny sensation.
