...
zones[xi.zone.CLOISTER_OF_TREMORS] =
{
    text =
    {
        ...
        TITAN_UNLOCKED                   = 7588, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ENTERING_THE_BATTLEFIELD_FOR     = 7676, -- Entering the battlefield for [Trial by Earth/The Puppet Master/Trial-Size Trial by Earth/Waking the Beast/Sugar-coated Directive/Trial by Earth]!
        ATTACH_SEAL                      = 7740, -- <player> attaches <item> to the protocrystal.
        POWER_STYMIES                    = 7741, -- An unseen power stymies your efforts to attach <item> to the protocrystal.
    },
    mob =
    {
