...
local getItemSelection = function(player, list, idx, idxAlt1, idxAlt2)
    ...
    -- FIX: Return the full table directly for List 11 (Armor Sets)
    -- This prevents wrapping the set in an extra table, which confuses npcUtil.giveItem
    if list == 11 or list == 20 then
        return itemList[list][idx]
    end
