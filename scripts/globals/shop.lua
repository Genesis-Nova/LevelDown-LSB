...
xi.shop.curioVendorMoogleStock =
{
    ...
    {
        { xi.item.SCROLL_OF_INSTANT_WARP,        2000, xi.ki.RHAPSODY_IN_WHITE },
        { xi.item.SCROLL_OF_INSTANT_RERAISE,     2000, xi.ki.RHAPSODY_IN_WHITE },
        { xi.item.SCROLL_OF_INSTANT_RETRACE,     2000, xi.ki.RHAPSODY_IN_AZURE },
        { xi.item.SCROLL_OF_INSTANT_PROTECT,     2000, xi.ki.RHAPSODY_IN_WHITE },
        { xi.item.SCROLL_OF_INSTANT_SHELL,       2000, xi.ki.RHAPSODY_IN_WHITE },
        { xi.item.SCROLL_OF_INSTANT_STONESKIN,   2000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.DIMENSIONAL_RING_HOLLA,      115500, xi.ki.RHAPSODY_IN_FUCHSIA },
    ...
    [xi.shop.curio.equipment] =
    {
        ...
        { xi.item.PRODIDIOUS_MANTLE,   30000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.ALGIDUS_CAPE,        10000, xi.ki.RHAPSODY_IN_UMBER },
        ...
        { xi.item.CUSTOM_F_BOOTS,     100000, xi.ki.RHAPSODY_IN_UMBER },
