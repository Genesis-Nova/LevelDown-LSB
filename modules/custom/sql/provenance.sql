...
INSERT INTO mob_groups VALUES(11525,4664,222,'Asb',300,0,0,500000,9999,0,NULL);
INSERT INTO mob_groups VALUES(11526,5315,222,'Pil',300,0,0,525000,9999,0,NULL);
INSERT INTO mob_groups VALUES(11527,4663,222,'Rukh',300,0,0,550000,9999,0,NULL);
INSERT INTO mob_groups VALUES(11528,4665,222,'Sarbaz',300,0,0,625000,9999,0,NULL);
INSERT INTO mob_groups VALUES(11529,4667,222,'Shah',300,0,0,650000,9999,0,NULL);
INSERT INTO mob_groups VALUES(11530,4666,222,'Wazir',300,0,0,700000,9999,0,NULL);
INSERT INTO mob_groups VALUES(11531,4654,222,'Provenance_Watcher',600,0,0,1500000,9999,0,NULL);
INSERT INTO mob_groups VALUES(11532,4666,77,'PR_Imp',180,0,0,50000,9999,0,NULL);
INSERT INTO mob_groups VALUES(11533,244,190,'PR_Armet_Beetle',180,0,169,45000,0,0,NULL);
INSERT INTO mob_groups VALUES(11534,7062,4,'PR_Bight_Rarab',180,0,309,45000,0,0,NULL);
INSERT INTO mob_groups VALUES(11535,7063,4,'PR_Camelopard',180,0,432,45000,0,0,NULL);
INSERT INTO mob_groups VALUES(11536,1802,52,'PR_Colibri',180,0,1225,45000,0,0,NULL);
INSERT INTO mob_groups VALUES(11537,6801,190,'PR_Cutlass_Scorpion',180,0,549,45000,0,0,NULL);
INSERT INTO mob_groups VALUES(11538,6460,190,'PR_Dire_Bat',180,0,0,45000,0,0,NULL);
INSERT INTO mob_groups VALUES(11539,7061,4,'PR_Ghost_Crab',180,0,2931,45000,0,0,NULL);
INSERT INTO mob_groups VALUES(11540,7058,190,'PR_Hati',180,0,1278,45000,5000,0,NULL);
INSERT INTO mob_groups VALUES(11541,7064,4,'PR_Hypnos_Eft',180,0,2379,45000,0,0,NULL);
INSERT INTO mob_groups VALUES(11542,2388,190,'PR_Lemures',180,0,1506,45000,5000,0,NULL);
INSERT INTO mob_groups VALUES(11543,7059,190,'PR_Spartoi_Sorcerer',180,0,2301,45000,5000,0,NULL);
INSERT INTO mob_groups VALUES(11544,7060,190,'PR_Spartoi_Warrior',180,0,2125,45000,0,0,NULL);
INSERT INTO mob_groups VALUES(11545,6391,190,'PR_Thousand_Eyes',180,0,2402,45000,5000,0,NULL);
INSERT INTO mob_groups VALUES(11546,3946,190,'PR_Tomb_Worm',180,0,0,45000,5000,0,NULL);
INSERT INTO mob_groups VALUES(11547,4355,52,'PR_Wivre',180,0,2952,45000,0,0,NULL);
UPDATE mob_spawn_points SET minLevel = 125, maxLevel = 125 WHERE mobname = 'Asb';
UPDATE mob_spawn_points SET minLevel = 120, maxLevel = 120 WHERE mobname = 'Pil';
UPDATE mob_spawn_points SET minLevel = 135, maxLevel = 135 WHERE mobname = 'Rukh';
UPDATE mob_spawn_points SET minLevel = 140, maxLevel = 140 WHERE mobname = 'Sarbaz';
UPDATE mob_spawn_points SET minLevel = 130, maxLevel = 130 WHERE mobname = 'Shah';
UPDATE mob_spawn_points SET minLevel = 145, maxLevel = 145 WHERE mobname = 'Wazir';
UPDATE mob_spawn_points SET minLevel = 150, maxLevel = 150 WHERE mobname = 'Provenance_Watcher';
UPDATE mob_spawn_points SET minLevel = 135, maxLevel = 137 WHERE mobname = 'PR_Imp';
UPDATE mob_spawn_points SET minLevel = 134, maxLevel = 136 WHERE mobname = 'PR_Armet_Beetle';
UPDATE mob_spawn_points SET minLevel = 135, maxLevel = 137 WHERE mobname = 'PR_Bight_Rarab';
UPDATE mob_spawn_points SET minLevel = 135, maxLevel = 137 WHERE mobname = 'PR_Camelopard';
UPDATE mob_spawn_points SET minLevel = 133, maxLevel = 135 WHERE mobname = 'PR_Colibri';
UPDATE mob_spawn_points SET minLevel = 135, maxLevel = 137 WHERE mobname = 'PR_Cutlass_Scorpion';
UPDATE mob_spawn_points SET minLevel = 133, maxLevel = 135 WHERE mobname = 'PR_Dire_Bat';
UPDATE mob_spawn_points SET minLevel = 137, maxLevel = 139 WHERE mobname = 'PR_Ghost_Crab';
UPDATE mob_spawn_points SET minLevel = 136, maxLevel = 137 WHERE mobname = 'PR_Hati';
UPDATE mob_spawn_points SET minLevel = 135, maxLevel = 137 WHERE mobname = 'PR_Hypnos_Eft';
UPDATE mob_spawn_points SET minLevel = 137, maxLevel = 139 WHERE mobname = 'PR_Lemures';
UPDATE mob_spawn_points SET minLevel = 135, maxLevel = 137 WHERE mobname = 'PR_Spartoi_Sorcerer';
UPDATE mob_spawn_points SET minLevel = 135, maxLevel = 137 WHERE mobname = 'PR_Spartoi_Warrior';
UPDATE mob_spawn_points SET minLevel = 135, maxLevel = 137 WHERE mobname = 'PR_Thousand_Eyes';
UPDATE mob_spawn_points SET minLevel = 131, maxLevel = 133 WHERE mobname = 'PR_Tomb_Worm';
UPDATE mob_spawn_points SET minLevel = 135, maxLevel = 137 WHERE mobname = 'PR_Wivre';
