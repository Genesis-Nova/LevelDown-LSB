...
m:addOverride("xi.items.abyssdivers_coffer.onItemUse", function(target)
    ...
    local loota = xi.itemUtils.pickItemRandom(convertLootGroup(lootone))
    local lootb = xi.itemUtils.pickItemRandom(convertLootGroup(loottwo))
    local lootc = xi.itemUtils.pickItemRandom(convertLootGroup(lootthree))
    local lootd = xi.itemUtils.pickItemRandom(convertLootGroup(lootfour))
    local loote = xi.itemUtils.pickItemRandom(convertLootGroup(lootfive))
    local lootf = xi.itemUtils.pickItemRandom(convertLootGroup(lootsix))
    local loot =
    {
        {loota,    1},
        {lootb,  qty},
