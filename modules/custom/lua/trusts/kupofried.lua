...
m:addOverride("xi.actions.spells.trust.kupofried.onSpellCast", function(caster, target, spell)
    ...
    trust:addStatusEffect(xi.effect.COLURE_ACTIVE, { power = 6, origin = trust, tick = 3, subType = xi.effect.CORSAIRS_ROLL, subPower = 120, tier = xi.auraTarget.ALLIES, flag = xi.effectFlag.AURA })
